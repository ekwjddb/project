...
$('document').ready(function() {
	 var area0 = ["카테고리 선택","침대","소파","화장대/옷장/수납","식탁/의자","테이블/책상/책장"];
	  var area1 = ["하위 카테고리 선택","싱글","킹","이층침대","패밀리","퀸"];
	   var area2 = ["하위 카테고리 선택","코너형","1인/웜체어","패브릭","리클라이너","4/6인 일자형"];
	   var area3 = ["하위 카테고리 선택","거실장","장식장","화장대/콘솔","옷장","서랍장"];
	   var area4 = ["하위 카테고리 선택","2인 이상","4인 이상","8인 이상", "식탁의자","테이블의자"];
	   var area5 = ["하위 카테고리 선택","소파 테이블","좌식 테이블","원목 테이블", "다용도 테이블","책상/책장"];
	   // 카테고리 선택 박스 초기화
	 //하위카테고리 선택 박스 초기화
