    	    ...
    	    $.ajax({
    	    	...
    	    	success : function(data, textStatus) {
	        		...
	        		if(data.trim()=='add_success'){
	        			alert("관심상품에 등록되었습니다.");
	        			$("#favoritHeart").attr("src", "${contextPath}/resources/images/heartfull.jpg");
...
$(document).ready(function(){ 
	...
	if(${isLogOn != true}){
		...
		document.getElementById('favoritHeart').style.display = 'inline';
	      ...
	      $.ajax({
	            ...
	            type : "GET",
	            url : "${contextPath}/favoritInquiry.do",
	            data:{
	            	productNum:productNum
	            },	
	            dataType : "text",
